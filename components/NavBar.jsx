...
function NavBar() {
  ...
  return (
    <div>
      <nav className="w-full bg-black opacity-40 fixed-top top-0 left-0 right-0 z-5">
                ...
                >
                  {navbar ? (
                    ...
                    <Image
                      ...
                      height={30}
                      alt="chibi.png"
                      className="focus:border-none active:border-none animate-bounce"
                    />
                  )}
                </button>
              </div>
            ...
            >
              <ul className="h-screen md:h-auto items-center justify-center md:flex ">
                <li className="pb-6 text-xl text-white py-2 md:px-6 text-center border-b-2 md:border-b-0  hover:bg-gray-900  border-gray-900  md:hover:text-gray-600 md:hover:bg-transparent">
                  <Link href="#about me" onClick={() => setNavbar(!navbar)}>
                    About
                  </Link>
                </li>
